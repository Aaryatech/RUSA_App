...
public class UpcomingEvent {
    ...
    @SerializedName("newsSourceUrlName")
    @Expose
    ...
    @Expose
    private Object eventDateFrom;
    @SerializedName("eventDateTo")
    @Expose
    private Object eventDateTo;
    @SerializedName("eventContactPerson")
    @Expose
    private Object eventContactPerson;
    @SerializedName("eventContactNumber")
    @Expose
    private Object eventContactNumber;
    ...
    @SerializedName("featuredImageAlignment")
    @Expose
    ...
    public Object getEventDateFrom() {
        return eventDateFrom;
    }

    public void setEventDateFrom(Object eventDateFrom) {
        this.eventDateFrom = eventDateFrom;
    }

    public Object getEventDateTo() {
        return eventDateTo;
    }

    public void setEventDateTo(Object eventDateTo) {
        this.eventDateTo = eventDateTo;
    }

    public Object getEventContactPerson() {
        return eventContactPerson;
    }

    public void setEventContactPerson(Object eventContactPerson) {
        this.eventContactPerson = eventContactPerson;
    }

    public Object getEventContactNumber() {
        return eventContactNumber;
    }

    public void setEventContactNumber(Object eventContactNumber) {
    ...
    public String toString() {
        return "UpcomingEvent{" +
                ...
                ", pageId=" + pageId +
                ", newsSourceUrlName='" + newsSourceUrlName + '\'' +
                ...
                ", pageMetaKeyword='" + pageMetaKeyword + '\'' +
